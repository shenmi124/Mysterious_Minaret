function levelnew(){
	...
	let newdeatk =  new Decimal(6).add(player.data.level.mul(0.5)).add(Math.random() * player.data.level.mul(1).pow(Decimal.add(1).add(player.data.level.div(100)))).floor()
	if(monsterup==0){
	...
	if(player.data.Normal_Artifacts[1].gt(0)){player.data.effect[1] = player.data.effect[1].add(player.data.Normal_Artifacts[1].mul(6))}
