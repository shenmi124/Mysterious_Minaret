function levelnew(){
	...
	let newdeatk =  new Decimal(6).add(player.data.level.mul(0.75)).add(Math.random() * player.data.level.mul(1).pow(Decimal.add(1).add(player.data.level.div(100)))).floor()
	if(monsterup==0){
